...
//   return (
//     <Container>
//       <Typography variant="h4" sx={{ my: 3 }}>Budget Dashboard - {month}</Typography>
...
//           <Card>
//             <CardContent>
//               <Typography variant="h5">Monthly Budget Goals</Typography>
//               {monthlyGoal ? (
...
//                   </thead>
//                   <tbody>
//                     {Object.entries(monthlyGoal).map(([key, value]) => (
//                       <tr key={key}>
//                         <td>{key.replace("_", " ")}</td>
//                         <td>{value}</td>
//                         <td>{progress?.[key] || 0}</td>
//                         <td>{Math.max(0, value - (progress?.[key] || 0))}</td>
//                       </tr>
//                     ))}
//                   </tbody>
//                 </table>
...
//           <Card>
//             <CardContent>
//               <Typography variant="h5">Sales & Revenue Progress</Typography>
...
//           <Card>
//             <CardContent>
//               <Typography variant="h5">Units Progress</Typography>
//               {progress && targets && monthlyGoal ? (
//                 <Bar
//                   data={{
...
//           <Card>
//             <CardContent>
//               <Typography variant="h5">Boss Count Progress</Typography>
//               {progress && targets && monthlyGoal ? (
//                 <Bar
//                   data={{
//                     labels: ["Boss Count"],
